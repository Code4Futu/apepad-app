const protocols = [
  ...
  {
    name: "Goal3",
    logo: "/logos/logo-dark-goal3.svg",
    logoHeight: "h-5",
    interactions: "45",
    activeDays: "89",
    volume: "$283",
    lastActivity: "a moment ago",
  },
  {
    name: "Mute.",
              ...
              <tbody>
                {protocols.map((item, idx) => (
                  <tr className={`tr`} key={idx}>
                    ...
                    <td className="td whitespace-nowrap text-right">{item.activeDays}</td>

                    <td className="td whitespace-nowrap text-right">{item.volume}</td>
